...
- WebSearch function to Fetch example component with Brave Search API integration and comprehensive test coverage ([#TBD](https://github.com/microsoft/wassette/pull/TBD))
- WebSearch function to the Fetch example component with support for query, max results, language, and region parameters ([#TBD](https://github.com/microsoft/wassette/pull/TBD))
