...
var loadPyodide = (() => {
    ...
    var o = (e, t) => A(e, "name", {
        ...
        m = (e => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, {
    ...
    var pe = (e, t) => {
        ...
        H = (e, t, r, s) => {
            if (t && typeof t == "object" || typeof t == "function")
                for (let a of ue(t)) !me.call(e, a) && a !== r && A(e, a, {
                    get: () => t[a],
                    enumerable: !(s = de(t, a)) || s.enumerable
                });
            return e
        };
    var b = (e, t, r) => (r = e != null ? ce(fe(e)) : {}, H(t || !e || !e.__esModule ? A(r, "default", {
            value: e,
            enumerable: !0
        }) : r, e)),
        ge = e => H(A({}, "__esModule", {
    ...
    function g(e) {
        if (e)
            for (var t = 0; t < T.length; t++) e[T[t]] !== void 0 && this["set" + E(T[t])](e[T[t]])
    }
    o(g, "StackFrame");
    g.prototype = {
        getArgs: o(function() {
    ...
    g.fromString = o(function(t) {
        var r = t.indexOf("("),
            ...
            i = t.substring(s + 1);
        if (i.indexOf("@") === 0) var l = /@(.+?)(?::(\d+))?(?::(\d+))?$/.exec(i, ""),
            c = l[1],
            d = l[2],
            u = l[3];
        return new g({
    ...
    for (h = 0; h < k.length; h++) g.prototype["get" + E(k[h])] = U(k[h]), g.prototype["set" + E(k[h])] = function(e) {
        return function(t) {
            this[e] = !!t
        }
    }(k[h]);
    var h;
    for (S = 0; S < I.length; S++) g.prototype["get" + E(I[S])] = U(I[S]), g.prototype["set" + E(I[S])] = function(e) {
        return function(t) {
    ...
    var S;
    for (w = 0; w < N.length; w++) g.prototype["get" + E(N[w])] = U(N[w]), g.prototype["set" + E(N[w])] = function(e) {
        return function(t) {
            this[e] = String(t)
        }
    }(N[w]);
...
`).filter(function(n) {
                ...
                return a.map(function(n) {
                    if (n.indexOf(" > eval") > -1 && (n = n.replace(/ line (\d+)(?: > eval line \d+)* > eval:\d+:\d+/g, ":$1")), n.indexOf("@") === -1 && n.indexOf(":") === -1) return new D({
                        functionName: n
                    });
                    var i = /((.*".+"[^@]*)?[^@]*)(?:@)/,
                        l = n.match(i),
    ...
    var y = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string" && !process.browser,
        ...
        we = typeof Deno < "u",
        J = !y && !we,
        Y = J && typeof window == "object" && typeof document == "object" && typeof document.createElement == "function" && "sessionStorage" in window && typeof importScripts != "function",
        K = J && typeof importScripts == "function" && typeof self == "object",
        qe = typeof navigator == "object" && typeof navigator.userAgent == "string" && navigator.userAgent.indexOf("Chrome") == -1 && navigator.userAgent.indexOf("Safari") > -1,
        R = typeof read == "function" && typeof load == "function";
    var X, M, Q, G, B;
    async function W() {
        if (!y || (X = (await import( /* webpackIgnore */ "node:url")).default, G = await import( /* webpackIgnore */ "node:fs"), B = await import( /* webpackIgnore */ "node:fs/promises"), Q = (await import( /* webpackIgnore */ "node:vm")).default, M = await import( /* webpackIgnore */ "node:path"), $ = M.sep, typeof m < "u")) return;
        let e = G,
    ...
    async function Fe(e) {
        e.startsWith("file://") && (e = e.slice(7)), e.includes("://") ? Q.runInThisContext(await (await fetch(e)).text()) : await import( /* webpackIgnore */ X.pathToFileURL(e).href)
    }
    o(Fe, "nodeLoadScript");
    async function ee(e) {
        if (y) {
            ...
            a = {
                ...
                getLocalSet: o(n => {
                    ...
                    for (; d.length;) {
                        let u = d.pop(),
                            f = t.stat(u);
                        t.isDir(f.mode) && d.push.apply(d, t.readdir(u).filter(l).map(c(u))), i[u] = {
                            timestamp: f.mtime,
                            mode: f.mode
                        }
                    }
                ...
                getRemoteSet: o(async n => {
                    ...
                    for (let [c, d] of l) c !== "." && (i[s.join2(n.mountpoint, c)] = {
                ...
                loadLocalEntry: o(n => {
                    ...
                    if (t.isFile(c.mode)) return l.contents = r.getFileDataAsTypedArray(l), {
                        timestamp: c.mtime,
                        mode: c.mode,
                        contents: l.contents
                    };
                ...
                storeRemoteEntry: o(async (n, i, l) => {
                    let c = n.get(s.dirname(i)),
                        d = t.isFile(l.mode) ? await c.getFileHandle(s.basename(i), {
                            create: !0
    ...
    var ie = V("AGFzbQEAAAABDANfAGAAAW9gAW8BfwMDAgECByECD2NyZWF0ZV9zZW50aW5lbAAAC2lzX3NlbnRpbmVsAAEKEwIHAPsBAPsbCwkAIAD7GvsUAAs=");
    ...
    function Ue(e) {
        let t;
        return e.stdLibURL != null ? t = e.stdLibURL : t = e.indexURL + "python_stdlib.zip", [De(t), Re(e.env.HOME), Oe(e.env), re, ...Le(e.fsInit)]
    }
    ...
    async function j(e = {}) {
        ...
        t = O(x(t));
        let r = e;
        if (r.packageBaseUrl = O(r.packageBaseUrl), r.cdnUrl = O(r.packageBaseUrl ?? `https://cdn.jsdelivr.net/pyodide/v${L}/full/`), !e.lockFileContents) {
        ...
        if (e.pyproxyToStringRepr && i.setPyProxyToStringMethod(!0), e.convertNullToNone && i.setCompatNullToNone(!0), i.version !== L && a.checkAPIVersion) throw new Error(`Pyodide version does not match: '${L}' <==> '${i.version}'. If you updated the Pyodide version, make sure you also updated the 'indexURL' parameter passed to loadPyodide.`);
        c.locateFile = f => {
