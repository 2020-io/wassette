...
if @ @ungetc_buf.empty ?
    ...
    # XXX: This might
return a buffer larger than the specified size,
...
class IO
def winsize
JSFuncs[: winsize].apply().to_a.map {
    | n | n.to_i
}.reverse
end
